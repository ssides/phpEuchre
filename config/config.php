<?php
  ...
  $cardFaces = "2"; // can be any number 1 to 5.  Selects different card faces.
  $firstJackChoices = 500;
  $dealChoices = 12000;
  $gameControllerLog = true;
  $clearTableDelay = 2;
  $version = '1.7:46'; // displayed in the header. change in version forces the browser to get the latest styles.
