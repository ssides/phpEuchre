...
// C:\src\phpEuchre\config\db.php
// C:\src\phpEuchre\index.php
include 'phpAuth/Auth.php';
include 'phpAuth/AuthInterface.php';
include 'phpAuth/Config.php';
include 'phpAuth/ConfigInterface.php';
include 'phpAuth/Helpers.php';
